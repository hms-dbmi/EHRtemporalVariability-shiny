                 ...
                 tabsetPanel(
                   ...
                   tabPanel("Load your csv",
                            mainPanel(
                              ...
                              br(),
                              p(
                                "To see what a correctly formatted data set looks like download the NHDS demo file below (limited to a subsample of the NHDS data)."
                              ),
                              tags$a(href = "nhdsSubset.csv", "Download the NHSD csv demo file here!"),
                              br(),
                              br(),
                              width = 12
                            ),
