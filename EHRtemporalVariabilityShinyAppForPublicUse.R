...
server <- function(input, output, session) {
  ...
  output$variableValue <- output$variableValue2 <- output$variableValue3 <- renderUI({
  ...
  output$igtdimensions <- output$igtdimensions3 <- renderUI({
  ...
  # output$daterangeValues <- output$daterangeValues2 <- output$daterangeValues3 <- renderUI({
  #     if(! is.null(dataValues$probMaps) ){
  ...
  output$heatmapvalues <- output$heatmapvalues3 <- renderUI({
  ...
  output$maxheatmapvaluesSlider <- output$maxheatmapvaluesSlider3 <- renderUI({
